        ...
        <div className="mt-0 space-y-6 text-[1.08rem] md:text-[1.13rem] text-black font-[500] text-center md:text-left">
          ...
          >
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>1 lucky winner will take home
                <span className="font-bold text-[#B2252A]"> Gold worth Rs. 21 lakhs</span>
              </li>
              <li>5 lucky winners will win
                <span className="font-bold text-[#B2252A]"> Rs.5 lakh cash prizes</span>
              </li>
          ...
          >
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>10 lucky winners (2 in each region) will win an
                <span className="font-bold text-[#B2252A]"> electric scooter</span>
              </li>
              <li>5 lucky winners (1 in each region) will
